...
export const ALL_RESOURCES = [
  ...
  // with RESOURCES in `@kaizen/shared/permissions.ts`.
  ...
  'review_cycles', 'reviews', 'calibrations', 'feedback', 'one_on_ones', 'pips', 'succession_plans', // WS5 performance
  ...
  'announcements', 'recognitions', 'surveys', 'hr_cases', 'policy_documents', 'exit_interviews', // WS9 engagement
...
const hrOpsManager: GrantSpec[] = [
  ...
  { resource: 'one_on_ones', cell: 'VCEDA' },
  ...
  { resource: 'policy_documents', cell: 'VCEDA' },
...
const financeHead: GrantSpec[] = [
  ...
  { resource: 'policy_documents', cell: 'V' },
...
const employee: GrantSpec[] = [
  ...
  { resource: 'one_on_ones', cell: 'VCE@own' },
  ...
  { resource: 'policy_documents', cell: 'V@all' },
  { resource: 'exit_interviews', cell: '-' },
