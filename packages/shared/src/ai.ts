...
export const AI_TOUCHPOINTS: AiTouchpoint[] = [
  ...
  {
    code: 'AI-MKT-001',
    surface: 'Campaign brief drafting',
    description: 'Drafting a campaign brief from objective, division and target inputs.',
    tier: 'DRAFT',
    tool: 'tool.mkt.draft_campaign_brief',
    boundary: 'A human reviews and edits the brief before the campaign leaves draft.',
  },
  {
    code: 'AI-MKT-002',
    surface: 'Message copy suggestion',
    description: 'Email/SMS/WhatsApp copy and subject-line suggestions for a template.',
    tier: 'DRAFT',
    tool: 'tool.mkt.suggest_message_copy',
    boundary: 'Never auto-sent — a human reviews and approves the template before any send uses it.',
  },
  {
    code: 'AI-MKT-003',
    surface: 'Audience suggestion',
    description: 'Suggesting an audience/segment definition from historical lead outcomes.',
    tier: 'RECOMMEND',
    tool: 'tool.mkt.suggest_audience',
    boundary: 'Proposes a rule tree for a human to accept; never creates or evaluates an audience directly.',
  },
  {
    code: 'AI-MKT-004',
    surface: 'Lead score rule tuning',
    description: 'Suggesting changes to MarketingLeadScoreRule weights from outcome data.',
    tier: 'RECOMMEND',
    tool: 'tool.mkt.suggest_score_rules',
    boundary: 'Never edits a scoring rule directly — the rule set is transparent and human-owned.',
  },
  {
    code: 'AI-MKT-005',
    surface: 'Next-best-action for a lead',
    description: 'Suggesting the next touchpoint or channel for a lead from its touchpoint history.',
    tier: 'RECOMMEND',
    tool: 'tool.mkt.suggest_next_action',
    boundary: 'Suggests only; never queues a send or enrols a journey run on its own.',
  },
  {
    code: 'AI-MKT-006',
    surface: 'Send metric anomaly alert',
    description: 'Flagging an anomalous bounce or unsubscribe rate on a send.',
    tier: 'AUTONOMOUS_WITHIN_POLICY',
    tool: 'tool.mkt.detect_send_anomaly',
    boundary: 'Raises an exception (EX-MKT-005/EX-MKT-006) only. Never pauses or cancels the send itself.',
  },
  {
    code: 'AI-MKT-007',
    surface: 'Send approval',
    description: 'Executing the approved transition on a MarketingSend.',
    tier: 'PROHIBITED',
    tool: '—',
    boundary: 'A send reaches people outside the company. Barred at every AUTHORITY_GRANT size.',
  },
  {
    code: 'AI-MKT-008',
    surface: 'Budget approval',
    description: 'Executing the approved transition on a MarketingBudget.',
    tier: 'PROHIBITED',
    tool: '—',
    boundary: 'This commits the company’s money. Barred at every AUTHORITY_GRANT size.',
  },
];
